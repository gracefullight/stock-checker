...
export async function backtest(opts: { costBps?: number; quick?: boolean } = {}) {
  ...
  const tickers = [
    ...
    'PLD',
    'AMT',
    // --- Large-N expansion (~290 more liquid large/mid caps, all sectors).
    // More tickers → more independent trades → win-rate claims with real
    // statistical power. Delisted/renamed symbols simply fail the fetch and
    // are skipped; every symbol here has a TICKER_SECTOR_ETF mapping. ---
    // Technology
    ...['TSM', 'ASML', 'NXPI', 'ADI', 'MCHP', 'ON', 'MPWR', 'TER', 'SNPS', 'CDNS'],
    ...['FTNT', 'WDAY', 'TEAM', 'MDB', 'OKTA', 'TWLO', 'HUBS', 'GTLB', 'APP', 'DELL'],
    ...['HPQ', 'NTAP', 'STX', 'WDC', 'PSTG', 'AKAM', 'ZM', 'BILL', 'PATH', 'GFS'],
    ...['MSTR', 'S'],
    // Communication Services
    ...['T', 'VZ', 'CMCSA', 'CHTR', 'WBD', 'FOXA', 'EA', 'TTWO', 'OMC', 'LYV'],
    ...['SPOT', 'MTCH', 'RDDT', 'TTD'],
    // Consumer Discretionary
    ...['ORLY', 'AZO', 'ROST', 'YUM', 'CMG', 'DPZ', 'MAR', 'HLT', 'RCL', 'CCL'],
    ...['NCLH', 'LVS', 'WYNN', 'MGM', 'DKNG', 'EXPE', 'EBAY', 'ETSY', 'CHWY', 'LULU'],
    ...['DECK', 'ONON', 'CROX', 'RL', 'TPR', 'PHM', 'DHI', 'LEN', 'F', 'BBY'],
    ...['ULTA', 'POOL', 'CVNA', 'KMX', 'TSCO'],
    // Consumer Staples
    ...['MDLZ', 'CL', 'KMB', 'GIS', 'HSY', 'KHC', 'STZ', 'TAP', 'MNST', 'CELH'],
    ...['KDP', 'CHD', 'CLX', 'EL', 'SYY', 'KR', 'TGT', 'DG', 'DLTR', 'ADM'],
    ...['TSN', 'PM', 'MO'],
    // Financials
    ...['WFC', 'C', 'SCHW', 'CB', 'PGR', 'TRV', 'ALL', 'MET', 'PRU', 'AIG'],
    ...['AFL', 'BK', 'STT', 'TFC', 'USB', 'PNC', 'COF', 'SYF', 'FITB', 'HBAN'],
    ...['RF', 'KEY', 'CFG', 'MTB', 'ICE', 'CME', 'SPGI', 'MCO', 'MSCI', 'NDAQ'],
    ...['CBOE', 'AON', 'MMC', 'AJG', 'IBKR', 'KKR', 'BX', 'APO', 'PYPL', 'FI'],
    // Health Care
    ...['AMGN', 'GILD', 'VRTX', 'REGN', 'BIIB', 'BMY', 'CVS', 'CI', 'ELV', 'HUM'],
    ...['MCK', 'ZTS', 'ISRG', 'SYK', 'BSX', 'MDT', 'EW', 'DXCM', 'IDXX', 'A'],
    ...['IQV', 'RMD', 'HCA', 'BDX', 'ALNY', 'NVO', 'AZN', 'PODD', 'EXAS', 'HIMS'],
    // Industrials
    ...['ETN', 'EMR', 'ITW', 'PH', 'ROK', 'DOV', 'CMI', 'PCAR', 'FDX', 'DAL'],
    ...['UAL', 'LUV', 'CSX', 'NSC', 'WM', 'RSG', 'URI', 'FAST', 'GWW', 'AME'],
    ...['TT', 'CARR', 'OTIS', 'JCI', 'IR', 'SWK', 'PWR', 'HWM', 'TDG', 'LHX'],
    ...['NOC', 'GD', 'AXON', 'HEI', 'VRT', 'ADP', 'PAYX', 'CTAS'],
    // Energy
    ...['EOG', 'OXY', 'PSX', 'VLO', 'MPC', 'KMI', 'WMB', 'OKE', 'LNG', 'FANG'],
    ...['DVN', 'HAL', 'BKR', 'EQT', 'TRGP', 'CTRA'],
    // Utilities
    ...['AEP', 'D', 'EXC', 'SRE', 'XEL', 'ED', 'WEC', 'ES', 'PEG', 'EIX'],
    ...['PPL', 'FE', 'AEE', 'CMS', 'DTE', 'ETR', 'NRG', 'VST', 'CEG', 'AES'],
    // Materials
    ...['APD', 'SHW', 'ECL', 'DD', 'DOW', 'PPG', 'ALB', 'CF', 'MOS', 'NEM'],
    ...['STLD', 'AA', 'VMC', 'MLM', 'IP', 'PKG', 'BALL', 'AVY', 'LYB', 'IFF'],
    // Real Estate
