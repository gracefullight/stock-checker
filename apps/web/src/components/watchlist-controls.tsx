...
export function WatchlistControls({ tickers }: WatchlistControlsProps) {
  ...
  return (
    <div className="space-y-4">
      ...
      >
        <label htmlFor="watchlist-ticker-input" className="sr-only">
          Ticker symbol
        </label>
        <Input
      ...
      {tickers.length > 0 && (
        ...
        <div className="flex flex-wrap gap-2" role="list" aria-label="Watched tickers">
          {tickers.map((ticker) => (
